...
public class ConfigPanelToggleModes implements ConfigPanel {
    ...
    public void draw(int mouseX, int mouseY, int scroll) {
        ...
        //amount
        GuiUtils.drawCenteredString(this.sliderValue ? s1 : s2, this.xPosition+this.sizeX*3/4, this.yPosition+this.sizeY/2-Minecraft.getMinecraft().fontRenderer.FONT_HEIGHT/2+1-scroll, textColor, active);
